...
class WorldMap(QObject):
    ...
    def __init__(self):
        ...
        for dat in [["oceantopleft", (0, 0), 'oceantopleft.png'], 
                    ["oceanbottomleft", (0, 999), 'oceanbottomleft.png'],
                    ["oceanbottomright", (999, 999), 'oceanbottomright.png'],
                    ["oceantopright", (999, 0), 'oceantopright.png']]:
            qimg = 'data/' + dat[2]
            img = fmGlobals.glwidget.createImage(qimg, -2, (0, 0, -1, -1), (dat[1][0], dat[1][1], -1, -1))

        for dat in [["Northwestia", (0, 0), 'landtopleft.png'], 
                    ["Southeastland", (0, 999), 'landbottomleft.png'],
                    ["Southwestshire", (999, 999), 'landbottomright.png'],
                    ["Northeastica", (999, 0), 'landtopright.png']]:
            qimg = 'data/' + dat[2]
            img = fmGlobals.glwidget.createImage(qimg, -1, (0, 0, -1, -1), (dat[1][0], dat[1][1], -1, -1))
